...
"""
    ...
    for i in range(1, max_num_a + 1):
        for j in range(1, max_num_b + 1):
            ...
            macro_filename = os.path.join(os.getcwd(), "macros", "generated", "addition", f"add_{i}_and_{j}.sql")
